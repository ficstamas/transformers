...
from transformers import LSHTokenizerFast
from transformers.models.lsh.tokenization_lsh import (
    VOCAB_FILES_NAMES,
    BasicTokenizer,
    LSHTokenizer,
    WordpieceTokenizer,
...
@require_tokenizers
class LSHTokenizationTest(TokenizerTesterMixin, unittest.TestCase):
    tokenizer_class = LSHTokenizer
    rust_tokenizer_class = LSHTokenizerFast
    ...
    def test_sequence_builders(self):
        tokenizer = self.tokenizer_class.from_pretrained("ficsort/lsh-base")
